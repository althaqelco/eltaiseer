  ...
  return (
    <Card className="overflow-hidden group hover:shadow-xl transition-all duration-300 border-0 bg-white rounded-xl">
      ...
      <Link href={`/property/${property.id}`} className="block">
        ...
        {/* Status Badge */}
        <Badge className={`absolute top-8 right-2 sm:top-10 sm:right-3 text-xs sm:text-sm ${
        ...
        <button
          ...
          className={`absolute top-2 left-2 sm:top-3 sm:left-3 p-1.5 rounded-full transition-all ${
            isFav 
