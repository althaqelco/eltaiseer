          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-2 text-gray-400">
                ...
                <a
                  ...
                  className="hover:text-white transition-colors"
                  onClick={() => trackEvent.custom("EmailClick", { email: "info@eltaiseer.com", location: "Footer" })}
                >
                  info@eltaiseer.com
                </a>
              </li>
            ...
            <div className="flex gap-3 mt-4">
              <a
                ...
                onClick={() => trackEvent.custom("SocialClick", { platform: "Instagram", location: "Footer" })}
              >
              ...
              <a
                ...
                className="bg-gray-800 p-2 rounded-full hover:bg-orange-500 transition-colors"
                aria-label="TikTok"
                onClick={() => trackEvent.custom("SocialClick", { platform: "TikTok", location: "Footer" })}
              >
              ...
              <a
                ...
                className="bg-gray-800 p-2 rounded-full hover:bg-orange-500 transition-colors"
                aria-label="Facebook"
                onClick={() => trackEvent.custom("SocialClick", { platform: "Facebook", location: "Footer" })}
              >
