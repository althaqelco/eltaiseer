...
export default function ClinicsClient({ initialProperties }: { initialProperties: Property[] }) {
  ...
  useEffect(() => {
    ...
    getAllPropertiesAsync().then((allProperties) => {
      const clinics = allProperties.filter(p => p.type === "عيادة");
      if (clinics.length > 0) setProperties(clinics);
    }).catch(console.error);
  }, []);
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <Breadcrumb items={breadcrumbPresets.clinics} />

      <div className="bg-gradient-to-l from-teal-900 via-teal-800 to-orange-900 py-12">
        <div className="container mx-auto px-4">
          ...
          <p className="text-gray-400 text-sm max-w-3xl leading-relaxed">
            عيادات طبية جاهزة للتشغيل في دمياط الجديدة. مواقع مميزة في المجمعات الطبية والمناطق الحيوية.
            تراخيص جاهزة ومساحات مناسبة لجميع التخصصات.
          </p>
        </div>
      </div>
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="mb-6"><p className="text-gray-600">عرض {paginatedProperties.length} من {filteredProperties.length} عيادة</p></div>
        ...
        {paginatedProperties.length > 0 ? (
          ...
          <div className="text-center py-16 bg-white rounded-xl">
            ...
            <p className="text-gray-500 text-lg">لا توجد عيادات متاحة حالياً</p>
        ...
        <div className="mt-12 bg-white rounded-xl p-6 shadow-sm">
          ...
          <div className="prose prose-gray max-w-none text-gray-600 leading-relaxed">
            ...
            <ul className="list-disc list-inside space-y-2">
              <li>مواقع في مجمعات طبية</li>
              <li>تراخيص طبية جاهزة</li>
              <li>تشطيبات مناسبة للعيادات</li>
              <li>مواقف سيارات للمرضى</li>
            </ul>
          </div>
        </div>
      </main>
