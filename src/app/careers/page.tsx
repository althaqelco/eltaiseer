...
const openPositions = [
  {
    ...
    description: "نبحث عن مستشار عقاري ذو خبرة للانضمام لفريقنا في دمياط الجديدة. المهام: استقبال استفسارات العملاء عبر الواتساب والهاتف، تنظيم معاينات العقارات، التفاوض وإتمام صفقات البيع، ومتابعة العملاء بعد البيع. المتطلبات: خبرة سنتين على الأقل في السوق العقاري المصري (يفضل دمياط الجديدة أو المنصورة الجديدة)، مهارات تواصل ممتازة، وإلمام بأحياء المدن الجديدة ومشاريع الإسكان القومي. المزايا: راتب أساسي + عمولات مجزية على كل صفقة.",
  },
  {
    title: "مسوق رقمي",
    type: "دوام كامل",
    location: "دمياط الجديدة / عن بعد",
    description: "نبحث عن مسوق رقمي للعمل من مقرنا بدمياط الجديدة أو عن بعد. المهام: إدارة حسابات السوشيال ميديا (فيسبوك، إنستجرام، تيك توك)، إنتاج محتوى إعلاني للعقارات، إدارة الحملات الممولة، وتحسين ظهور الموقع في محركات البحث. المتطلبات: خبرة سنة على الأقل في التسويق الرقمي، إتقان أدوات Meta Ads، ويفضل خبرة في المجال العقاري.",
  },
  {
    title: "مصور عقارات",
    type: "دوام جزئي",
    location: "دمياط الجديدة",
    description: "نبحث عن مصور محترف بدوام جزئي لتصوير العقارات في دمياط الجديدة والمنصورة الجديدة. المهام: تصوير الوحدات السكنية والتجارية داخلياً وخارجياً، إنتاج فيديوهات ريلز قصيرة للسوشيال ميديا، وتصوير جوي بالدرون للأحياء والمشاريع. المتطلبات: امتلاك معدات تصوير احترافية، خبرة في التصوير المعماري أو العقاري، وإجادة المونتاج الأساسي. العمل بنظام الجلسات مع جدول أسبوعي مرن.",
  },
];
